...
**What to build:** Full Holdem side-pot support, extending 014's single-pot flow to correctly handle players going all-in for different amounts. The exact mechanical rule is specified in `002-v2-architecture.md` Q6/Q7 — implement it as written there.
