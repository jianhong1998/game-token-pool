...
**What to build:** A new user can register with a username and password, and log back in — the custodial account model from `002-v2-architecture.md` Q1 (password is a stored hash for login gating only, not a signing secret).
