...
- [ ] Allowed unconditionally — no blocking on round/pot state (per `002-v2-architecture.md` Q11). This ticket only needs General Mode to exist, so there's no pot to reconcile yet.
