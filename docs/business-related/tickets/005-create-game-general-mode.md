...
- [ ] `create_game` instruction: takes a client-generated UUID v7 game ID, creates the `Game` PDA and its own SPL mint (2 decimals, per `002-v2-architecture.md` Q9), sets the creator as game admin, and adds the game to the `Registry`.
