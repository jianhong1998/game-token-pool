...
**What to build:** The third game mode — a single continuous pool with fully admin-discretionary payouts and no contributor-eligibility restriction (per `002-v2-architecture.md` Q10, deliberately simpler than Poker Mode).
